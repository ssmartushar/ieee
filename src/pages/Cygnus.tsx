      ...
      <section className="relative z-10 py-10 sm:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            >
              <div className="inline-block border border-white/30 rounded-2xl p-4 sm:p-6 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-yellow-600/60 to-yellow-800/60 border border-yellow-400/50 rounded-2xl sm:rounded-3xl p-4 sm:p-8 flex flex-col justify-center backdrop-blur-sm"
            >
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-blue-600 to-blue-800 border border-blue-400 rounded-2xl sm:rounded-3xl p-4 sm:p-8 flex flex-col justify-center"
            >
              <div className="flex items-center mb-4 sm:mb-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.3 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-purple-600 to-purple-800 border border-purple-400 rounded-2xl sm:rounded-3xl p-4 sm:p-8 flex flex-col justify-center"
            >
              <div className="flex items-center mb-4 sm:mb-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.4 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-green-600 to-green-800 border border-green-400 rounded-2xl sm:rounded-3xl p-4 sm:p-8 flex flex-col justify-center"
            >
              <div className="flex items-center mb-4 sm:mb-6">
